...
import com.aeappss.hashtags.adapter.CustomAdapter;
...
public class ChatFragment extends Fragment {
    ...
    int [] thumbnail = {R.drawable.ic_camera_enhance_black_24dp, R.drawable.ic_camera_enhance_black_24dp,R.drawable.ic_camera_enhance_black_24dp};
    String [] judul = {"Kampus Koding","Kampus Koding","Kampus Koding"}; // text1
    String [] deskripsi = {"belajar programming","belajar programming","belajar programming"}; // text2
